...
import { Bars3Icon, XMarkIcon, ShoppingCartIcon, UserPlusIcon } from '@heroicons/react/24/outline'
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
                ...
                {navigation.map((item) => (
                  <Link
                    ...
                    className={classNames(
                      item.current ? 'bg-gray-950/50 text-white' : 'text-gray-100 hover:bg-white/20 hover:text-white',
          ...
          <div className="absolute inset-y-0 right-0 flex items-center gap-4 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <ShoppingCartIcon className='size-7 cursor-pointer transform hover:scale-110'/>

            <UserPlusIcon className='size-7 cursor-pointer transform hover:scale-110'/>
